...
export default function HeroSection() {
    return (
        <section className="relative bg-white pt-32 pb-12 md:pt-48 md:pb-32 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
                <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12 h-full">
                    ...
                    <div className="flex-1 text-center md:text-left z-10">
                        ...
                        <div className="inline-flex items-center gap-2 bg-orange-50 px-4 py-2 rounded-none mb-6 border border-orange-100">
                        ...
                        <h1 className="text-5xl md:text-7xl font-black text-gray-900 leading-tight mb-6 uppercase tracking-tight">
                            Master The <br />
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4">
                            ...
                            <Link
                                to="/new-arrivals"
                                className="group relative w-full sm:w-auto inline-flex items-center justify-center px-8 py-4 font-bold text-white bg-gray-900 uppercase tracking-widest overflow-hidden transition-all hover:bg-black hover:shadow-xl focus:outline-none ring-offset-2 focus:ring-2 ring-gray-900"
                            >
                            ...
                            <Link
                                to="/shop/pants"
                                className="w-full sm:w-auto inline-flex items-center justify-center px-8 py-4 font-bold text-gray-900 border-2 border-gray-900 uppercase tracking-widest transition-all hover:bg-gray-900 hover:text-white"
                            >
                                Shop Tops
                            </Link>
                        </div>
                    ...
                    <div className="flex-1 relative w-full h-[500px] md:h-[650px] group">
                        ...
                        <div className="absolute bottom-10 left-6 right-6 md:right-auto md:w-64 bg-white/95 backdrop-blur shadow-xl p-4 rounded border border-white/20 transform translate-y-2 opacity-90 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
                            <div className="flex items-start justify-between">
                                <div>
                                    <p className="text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-1">Featured Fit</p>
                                    <p className="text-sm font-bold text-gray-900 uppercase leading-snug">Heavyweight Tee - 200GSM</p>
                                </div>
