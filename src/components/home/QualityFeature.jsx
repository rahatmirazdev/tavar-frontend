    ...
    <section className="bg-white py-16 md:py-24 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-[400px] md:h-[600px] w-full rounded-none overflow-hidden group shadow-2xl">
            ...
            <div className="absolute bottom-8 left-8 bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-none">
              ...
              <p className="text-white text-2xl font-black uppercase">Premium Cotton</p>
            </div>
          </div>

          {/* RIGHT: The Logical Argument */}
          <div className="lg:pl-10">
            <h2 className="text-orange-600 font-bold uppercase tracking-widest text-sm mb-2">
              The Details Matter
            </h2>
            <h3 className="text-4xl md:text-5xl font-black text-gray-900 uppercase tracking-tighter leading-none mb-6">
              Why We Are <br />
              ...
              {features.map((feature) => (
                <div key={feature.title} className="flex gap-4">
                  <div className="flex-shrink-0">
                    <div className="flex items-center justify-center h-12 w-12 rounded-none bg-orange-50 text-orange-600">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-base text-gray-500 leading-relaxed">
                      {feature.description}
                    </p>
                  </div>
                </div>
            ...
            <div className="mt-10">
              <a href="/about-fabric" className="inline-flex items-center text-sm font-bold uppercase tracking-widest border-b-2 border-gray-900 pb-1 hover:text-orange-600 hover:border-orange-600 transition-colors">
                Read The Full Specs
              </a>
            </div>
